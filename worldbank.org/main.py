...
webScrapObj = WebScrapper(publishStartDate,publishEndDate,expiryDate,TotalRecords , dataCount)
webScrapObj.getData()
...
while str(quitTxt).lower() != str("q").lower():
    ...
    print("\nThank you for trying Worldbank Data Mining Scripts.\nBest Regards. Sahil Choudhary.") 
exit(0)